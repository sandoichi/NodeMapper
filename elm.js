...
var _user$project$Connectors$UIPanelData = F4(
	function (a, b, c, d) {
		return {nodeId: a, exitSide: b, entrySide: c, cost: d};
	});
...
var Elm = {};
Elm['Connectors'] = Elm['Connectors'] || {};
if (typeof _user$project$Connectors$main !== 'undefined') {
    _user$project$Connectors$main(Elm['Connectors'], 'Connectors', undefined);
}
